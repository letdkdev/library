    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <form action="/user/update_process" method="post">
                ...
                <label for="name">이름: </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="name" id="name" value="${userInfo.name}"><br>

                <hr>

                <label for="age">나이: </label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="age" id="age" value="${userInfo.age}"><br>
